...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] max-auto mt-10 text-center'>Trun text to <span className='text-blue-600'
      initial={{opacity:0}}
      animate={{opacity: 1 }}
      ...
      initial={{opacity:0,y:20}}
      animate={{opacity: 1, y: 0 }}
      transition={{delay: 0.6 , duration:0.8}}>Unless your creativity with AI. Turn Your imagination into visul art in second - just type, and watch the magic happen.</motion.p>
